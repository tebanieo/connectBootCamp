...
def lambda_handler(event,context):
    ...
    if 1 in response.values():
        ...
        userReturn = {
            ...
            "menu" : addTags(str(response['Items'][0]['menu'])),
            "flowOne": str(response['Items'][0]['flowOne']),
            "flowTwo": str(response['Items'][0]['flowTwo'])
        }
        ...
        userReturn = {
            ...
            "menu": addTags("DefaultLambda"),
            "flowOne": addTags("DefaultLambda"),
            "flowTwo": addTags("DefaultLambda")
        }
